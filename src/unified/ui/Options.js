...
export default class Options {
  constructor(orrery) {
    ...
    this.colorizeInput.title = "Color the shown groups by orbit: Near Earth teal, Hungarias orange, the belt in rose from light inner to dark outer, Hildas blue, Jupiter Trojans gold, Distant violet. Turning it off lasts the visit.";
