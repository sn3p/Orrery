...
async function invalidations(page) {
  ...
  await page.locator('#orrery-fps').dispatchEvent('pointerup', { pointerId: 7, pointerType: 'touch', clientY: 180 });
  ...
  await page.locator('#orrery-fps').dispatchEvent('pointerup', { pointerId: 8, pointerType: 'touch', clientY: 108 });
